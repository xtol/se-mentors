...
public class UserDetailsServiceImp extends RemoteServiceServlet implements
		UserDetailsService {
	...
	public String getUsername(String email) {
		...
		try {
			...
			rs = st.executeQuery("select username from reg_page2 where email='"
					+ email + "'");
	...
	public String getDob(String email) {
		...
		try {
			...
			rs = st.executeQuery("select date,month,year from reg_page2 where email='"
					+ email + "'");
	...
	public String getCity(String email) {
		...
		try {
			...
			rs = st.executeQuery("select city from reg_page2 where email='"
					+ email + "'");
	...
	public String getCountry(String email) {
		...
		try {
			...
			rs = st.executeQuery("select country from reg_page2 where email='"
					+ email + "'");
	...
	public String getAddress(String email) {
		...
		try {
			...
			rs = st.executeQuery("select address from reg_page2 where email='"
					+ email + "'");
	...
	public String getPhone(String email) {
		...
		try {
			...
			rs = st.executeQuery("select ph_no from reg_page2 where email='"
					+ email + "'");
	...
	public String getPincode(String email) {
		...
		try {
			...
			rs = st.executeQuery("select pincode from reg_page2 where email='"
					+ email + "'");
	...
	public String getFname(String email) {
		...
		try {
			...
			rs = st.executeQuery("select firstname from reg_page where email='"
					+ email + "'");
	...
	public String getMname(String email) {
		...
		try {
			...
			rs = st.executeQuery("select middlename from reg_page where email='"
					+ email + "'");
	...
	public String getLname(String email) {
		...
		try {
			...
			rs = st.executeQuery("select lastname from reg_page where email='"
					+ email + "'");
	...
	public boolean getPUsername(String email) {
		call();
		try {
			rs = st.executeQuery("select username from permission where email='"
					+ email + "'");
	...
	public boolean getPDob(String email) {
		call();
		try {
			rs = st.executeQuery("select date from permission where email='"
					+ email + "'");
	...
	public boolean getPCity(String email) {
		call();
		try {
			rs = st.executeQuery("select city from permission where email='"
					+ email + "'");
	...
	public boolean getPCountry(String email) {
		call();
		try {
			rs = st.executeQuery("select country from permission where email='"
					+ email + "'");
	...
	public boolean getPAddress(String email) {
		call();
		try {
			rs = st.executeQuery("select address from permission where email='"
					+ email + "'");
	...
	public boolean getPPhone(String email) {
		call();
		try {
			rs = st.executeQuery("select ph_no from permission where email='"
					+ email + "'");
	...
	public boolean getPPincode(String email) {
		call();
		try {
			rs = st.executeQuery("select pincode from permission where email='"
					+ email + "'");
	...
	public boolean getPFname(String email) {
		call();
		try {
			rs = st.executeQuery("select firstName from permission where email='"
					+ email + "'");
	...
	public boolean getPMname(String email) {
		call();
		try {
			rs = st.executeQuery("select middleName from permission where email='"
					+ email + "'");
	...
	public boolean getPLname(String email) {
		call();
		try {
			rs = st.executeQuery("select lastname from permission where email='"
					+ email + "'");
	...
	public String updateuser(String firstName, String middleName,
		...
		String ss1 = "no";
		try {
			ss = st.execute("update reg_page set firstName='" + firstName
	...
	public String updateuser1(String emai, String username, String country,
		...
		String ss1 = "no";
		try {
			ss = st.execute("update reg_page2 set username='" + username
	...
	public String updatepermission(String email, int firstName, int middleName,
		...
		String ss1 = "no";
		try {
			ss = st.execute("update permission set firstName='" + firstName
