...
public class SendMailServiceImp extends RemoteServiceServlet implements SendMailService {

	public String sendMail(String sendto,String message_mi){
		// TODO Auto-generated method stub
		// Recipient's email ID needs to be mentioned.
			String sender_email = "twinkletalways@gmail.com",
			sender_password = "Twinkleall",
			sender_host = "smtp.gmail.com",
			sender_port = "465",
			reciever_id=sendto,
			subject_to_be_given = "Authentication Email verification";
			...
			Properties props = new Properties();
			 ...
			 String message = "<div style=\"color:red;\"><table><tr><td>Welcome to Authentication</td></tr><tr><td> Your code: </td></tr></table>"+message_mi+"</div>";
