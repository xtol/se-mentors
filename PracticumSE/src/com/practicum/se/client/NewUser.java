...
boolean check1=false;
 public NewUser(final String email)
 {
  ...
  Label NUEnterCode =new Label("Enter the code which is sent to your 'Email-ID' ");
  Label NUusername = new Label("Username (How you want others to recognise you)"); 
 ...
 HorizontalPanel hp=new HorizontalPanel();
  ...
  NUbutton.addClickHandler(new ClickHandler() 
  {
		public void onClick(ClickEvent event) 
		{
			...
			final String s2 = ( NUgenderftb.getValue()) ?  NUgenderftb.getText() :  NUgendermtb.getText();
			...
			signupService.performSignup(captcha, new AsyncCallback<Boolean>()
					{
			...
			a2.newuser1(s1,s2, s3, s4, s5,s6,s7,s8,s9,s10,s11,email,new AsyncCallback<String>() 
					{
