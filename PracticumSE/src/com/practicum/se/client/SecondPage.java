...
public class SecondPage extends Composite {
	...
	public SecondPage() {
		...
		fp1.setWidget(0, 0, Fnamelb);
		fp1.setWidget(0, 1, Mnamelb);
		fp1.setWidget(0, 2, Lnamelb);
		fp1.setWidget(1, 0, FnameTextBox);
		fp1.setWidget(1, 1, MnameTextBox);
		fp1.setWidget(1, 2, LnameTextBox);
		fp1.setWidget(2, 0, EnterEmaillb);
		fp1.setWidget(2, 1, EnterEmailTextBox);
		fp1.setWidget(3, 0, ReenterEmaillb);
		fp1.setWidget(3, 1, ReenterEmailTextBox);
				...
				a2.newuser(s1, s2, s3, s4, s5, new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						if (result.equals("yes")) {
							...
							vp.clear();
							// NewUser n=new
							// NewUser(ReenterEmailTextBox.getText());
		...
		LoginButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				if (!FieldVerifier.isValidName(s1, s2)) {
					...
					errorLabel
							.setText("Please enter correct username or password");
