...
public interface UserDetailsService extends RemoteService {
	...
	String updateuser(String firstName, String middleName,String lastName,String email);
    String updateuser1(String email,String username,String country, String city, String pincode 
    		,String address,String ph_no,
			String date,String month, String year); 
    String updatepermission(String email,int  firstName,int  middleName, int  lastname, int  username 
    		,int  country,int  city,
    		int  pincode,int  address, int  ph_no,int  dob);
