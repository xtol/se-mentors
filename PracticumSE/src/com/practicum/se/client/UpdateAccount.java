		 ...
		 fp.setWidget(11, 1, UpdateButton);
		  ...
		  UpdateButton.addClickHandler(new ClickHandler()
		  {
			...
			public void onClick(ClickEvent event) {
				...
				a2.updateuser1(s1, ub1, ub7, ub6, ub9, ub8, ub10, ub5, ub5, ub5,new  AsyncCallback<String>() {
				...
				a2.updatepermission(s1, Integer.parseInt(ubppr2), Integer.parseInt(ubppr3), Integer.parseInt(ubppr4), Integer.parseInt(ubppr1), 
						Integer.parseInt(ubppr7), Integer.parseInt(ubppr6),
						Integer.parseInt(ubppr9), Integer.parseInt(ubppr8), Integer.parseInt(ubppr10), Integer.parseInt(ubppr5), new  AsyncCallback<String>()
						{
